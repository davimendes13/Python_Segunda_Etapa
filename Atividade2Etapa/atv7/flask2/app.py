...
@app.route("/")
def index():
    # TODO ALUNO: busque todos os produtos ordenados por nome -> CORRIGIDO
...
def cadastrar():
    if request.method == "POST":
        ...
        # TODO ALUNO: add + commit -> CORRIGIDO
...
def editar(produto_id):
    # TODO ALUNO: buscar produto pelo id -> CORRIGIDO
...
def excluir(produto_id):
    # TODO ALUNO: buscar, delete e commit -> CORRIGIDO
    produto = db.session.get(Produto, produto_id)
    if produto:
